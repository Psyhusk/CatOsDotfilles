...
setup_daemon_logging("CatOsDotfillesClipboardListener")
logger = logging.getLogger("CatOsDotfillesClipboardListener")

try:
    import setproctitle

    setproctitle.setproctitle("catdots-cliphist-d")
