...
from catdots.library.config_utils import get_config, set_config
from catdots.constants import WEATHER_ICONS, WEATHER_SECTION
...
class GetWeatherData(BaseAction):
    ...
    def format_weather_tooltip(self, data) -> str:
        ...
        if not data:
            return "Invalid Credentials! \nPlease update your API key and location in ~/.catdots/setting.ini [Weather] section"
