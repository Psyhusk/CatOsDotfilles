...
from catdots.library.fs_ops import remove, create_symlink, path_lexists, copy
from catdots.library.cli_utils import print_header, Spinner
from catdots.constants import (
    USER_CONFIGS_DIR,
    USER_DOTFILES_DIR,
    CATDOTS_DOTFILES_DIR,
...
class DotfilesInstaller:
    def __init__(self, logger: Logger, dry_run: bool, verbose: bool):
        ...
        self.source_dotfiles_components_paths = [
            CATDOTS_DOTFILES_DIR / i for i in self.dotfiles_components
        ]
