"""
Global constants for CatOsDotfilles.
...
CATDOTS_CONFIG_DIR = HOME / ".catdots"
CATDOTS_DATA_DIR = Path("/usr/share/catdots")
CATDOTS_STATE_DIR = (
    Path(os.environ.get("XDG_STATE_HOME", HOME / ".local" / "state")) / "catdots"
)

CATDOTS_DOTFILES_DIR = CATDOTS_DATA_DIR / "configs"
CATDOTS_WALLPAPERS_DIR = CATDOTS_DATA_DIR / "wallpapers"
CATDOTS_LOG_DIR = CATDOTS_STATE_DIR / "logs"


DEFAULT_RICH_THEME_PATH = Path("/etc") / "catdots" / "rich_theme.toml"
...
CACHE_FILE = CATDOTS_STATE_DIR / "cliphist"
MAX_ENTRIES = 50
MAX_LENGTH = 200
POLL_SEC = 0.2
