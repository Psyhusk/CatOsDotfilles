...
def setup_logging(
    ...
    *,
    ...
    """
    Configure logging for cli: catdotsctl, catdots, etc.
...
def setup_daemon_logging(
    ...
    *,
    ...
    """
    Configure logging for a CatOsDotfilles-Daemon scripts.
...
def setup_actions_state(name: str, log_level=LogLevel.DEBUG.value) -> None:
    """
    Configure logging for CatOsDotfilles-Actions to save as states.
    """
    # Ensure state dir exists
    state_dir = CATDOTS_STATE_DIR
...
def get_caller_logger(default: str = "catdots") -> logging.Logger:
    """
