...
from catdots.library.configDicts import ConfigResolvedDict, OneLevelFlatDict
from catdots.library.exceptions import ConfigNotFound
from catdots.library.logger import get_caller_logger
from catdots.constants import CATDOTS_CONFIG_DIR, DEFAULT_SECTION

SETTINGS_FILE = CATDOTS_CONFIG_DIR / "setting.ini"


def _ensure_paths() -> None:
    CATDOTS_CONFIG_DIR.mkdir(parents=True, exist_ok=True)
