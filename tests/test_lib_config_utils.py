...
from catdots.library.config_utils import (
    get_config,
    set_config,
    _ensure_paths,
    _load_config,
...
class TestConfigUtils:
    ...
    @patch("catdots.library.config_utils.SBDOTS_CONFIG_DIR")
    @patch("catdots.library.config_utils.SETTINGS_FILE")
    def test_ensure_paths_creates_directories(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_config_dir.return_value = temp_path / ".catdots"
            mock_settings_file.return_value = temp_path / ".catdots" / "setting.ini"
    ...
    def test_load_config_returns_configparser(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("catdots.library.config_utils.SBDOTS_CONFIG_DIR", temp_path):
                with patch("catdots.library.config_utils.SETTINGS_FILE", settings_file):
                    cfg = _load_config()
    ...
    @patch("catdots.library.config_utils._load_config")
    @patch("catdots.library.config_utils._atomic_write")
