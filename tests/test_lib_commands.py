...
from catdots.library.commands import run_command
from catdots.library.exceptions import CommandNotFound


class TestCommands:
    """Tests for commands module"""

    @patch("catdots.library.commands.subprocess.run")
    ...
    @patch("catdots.library.commands.which")
