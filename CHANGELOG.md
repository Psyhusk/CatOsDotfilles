...
- `catdotsctl` command with waybar flags for enhanced control.
- Project logo (catdots.svg) in assets.
- `catdots-actions` daemon for managing system actions and automation.
...
- Changed project name from HyprDots to CatOsDotfilles.
