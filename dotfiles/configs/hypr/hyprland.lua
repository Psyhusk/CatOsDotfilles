...
hl.on("hyprland.start", function()
    hl.exec_cmd("catdotsctl waybar --start")
    hl.exec_cmd("systemctl --user start --now hyprpolkitagent")
    hl.exec_cmd("systemctl --user start --now swaync.service")
    hl.exec_cmd("systemctl --user start --now catdots-actions.service")
    hl.exec_cmd("systemctl --user start --now catdots-clipboard-listener.service")
