...
hl.bind(mainMod .. " + CTRL + R ", hl.dsp.exec_cmd("catdotsctl waybar -rc"))                    -- Reload Waybar's configs
hl.bind(mainMod .. " + CTRL + T ", hl.dsp.exec_cmd("catdotsctl waybar -r"))                     -- Reload Waybar
